...
kmfunc <- function(qi, time, event, eventname, yposplus = rep(0.03, 2), xplace = 2) {
  cexmy <- 1.2
  endtime <- 6
  ...
  mtext("No. at risk", side = 1, line = 3.5, at = -670, adj = 0, cex = cexmy, font = 2)
  mtext(levs[1], side = 1, line = 4.5, at = -670, adj = 0, cex = cexmy)
  mtext(levs[2], side = 1, line = 5.5, at = -670, adj = 0, cex = cexmy)
