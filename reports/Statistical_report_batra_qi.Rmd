...
Note that the EF QI is removed from the opportunity based score no 2.

### Sensitivity analysis

For the CRT and ICD QI a sensitivity analysis was performed throughout including patients with EF <40% instead of <30% and 
...
(GLMM) with a logit link and a random effect for centre. The OR are unadjusted.
